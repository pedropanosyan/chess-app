...
//                PieceType.WHITE_PAWN, new BasicMovementValidator[]{coronationValidator, whitePawnValidator},
//                PieceType.BLACK_PAWN, new BasicMovementValidator[]{coronationValidator, blackPawnValidator},
...
//        ), List.of(underCheck), List.of(new CheckMateValidator()) , 10);
//
